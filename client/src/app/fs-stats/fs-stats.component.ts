...
@Component({
  selector: 'app-fs-stats',
  templateUrl: './fs-stats.component.html',
  styleUrls: ['./fs-stats.component.css'],
   animations: [
    trigger(
      'enterAnimation', [
        transition(':enter', [
...
export class FsStatsComponent implements OnInit {

  // hours data
  morningOf;
  title = "Drop-In Futsal";
  //Stat 
  tgapspan = true;
  todayStats: Stat[];
  todayStatsR: Stat[];
